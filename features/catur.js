...
async function kirimCatur(sock, chatId) {
...
async function handleCatur(sock, msg, from) {
    try {
        await kirimCatur(sock, from);
    } catch (e) {
        console.error('[CATUR]', e?.message || e);
        await sock.sendMessage(from, { text: '❌ Gagal mengirim game catur: ' + (e?.message || e) }, { quoted: msg });
    }
}

module.exports = handleCatur;